...
PLAYER_DICT = {
    'pulse_lma_local_op_obs': {
        'cfg': 'pulse_lma_local_op_obs_self_play_pp.yaml',
        'dstep': 0,
    },
...
DUMMY_WEIGHT_PATH = "./output/HumanoidIm/tabletennis2_compete/pulse_lma_local_op_obs/0/Humanoid.pth"
                    ...
                    for k1, v1 in PLAYER_DICT.items():
                        for k2, v2 in PLAYER_DICT.items():
                            ...
                            args = [
                                ...
                                "env=env_amp_z_lma_pp_match",
                                f"env.num_envs={ENV_NUM}",
                                "env.task=HumanoidPP2ZLocalOpObs",
                                ...
                                "+learning.params.config.csv_file_name=match_results_pp.csv",
                                "epoch=-1",
                                "no_log=True",
                            ...
                            shutil.copy2("./match_results_pp.csv", os.path.join(DST_DIR, TASK_NAME, "match", k1, str(n1), save_csv_name))
                            os.remove("./match_results_pp.csv")
