...
METHOD_DICT = {
    'pulse_expansion_local_op_obs': {
        'learning': 'pulse_expansion_local_op_obs_self_play_tennis2',
        'exp_name': 'pulse_expansion_local_op_obs',
        'env': 'env_amp_z_compete',
...
def main():
    for i in range(ITERATION_NUM):
        for k, v in METHOD_DICT.items():
            ...
            if os.path.exists(os.path.join(weight_save_dir, "Humanoid_00010000.pth")):
                continue
