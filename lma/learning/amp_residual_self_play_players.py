...
class AMPResidualSelfPlayPlayerContinuous(common_player.CommonPlayer):
    ...
    def get_action(self, obs, is_determenistic=False):
        obs = obs['obs']
        self_task_obs = obs[..., :-self.task_local_op_obs_size]
        task_actions = self.env.task.get_task_action(self_task_obs)
        ...
        if self.opp_agent == 1:
            current_action = task_actions[:num_actors] + current_action
            current_oppoent_action = task_actions[num_actors:] + current_oppoent_action
